...
func (b basicAuth) ServeHTTP(w http.ResponseWriter, r *http.Request) {
	...
	isAuthenticated := given && b.authenticate(r, givenUser, givenPass)

	if r.URL.Path == b.opts.Path && isAuthenticated == false {
		b.requestAuth(w, r)
		return
	}
...
func (b *basicAuth) authenticate(r *http.Request, givenUser string, givenPass string) bool {
